...
const translations = {
  en: {
    ...
    candidate_ledger: "Student Practical Records",
    pre_lab_drill: "Pre-Lab Warmup →",
    tab_benches: "Laboratory Benches",
    tab_reference: "Revision & Reference",
    tab_achievements: "Badges & History",
    tab_research: "Assessments & Surveys",
    m_workbenches: "Workbenches",
    m_revision: "Revision",
    m_badges: "Badges",
    m_research: "Research",
    daily_bite_tag: "Daily Challenge",
    daily_bite_bonus: "+100 XP",
    daily_bite_timer: "Resets at midnight",
    daily_bite_title: "Daily Quick Quiz",
    daily_bite_desc: "3 quick questions to practice observation and calculations.",
    daily_bite_launch: "Start Quiz →",
    drills_title: "Practical Diagnostic Drills",
    drills_sub: "Timed quizzes by topic:",
    drills_badge: "Quick Drills",
    ...
    drill_surv_title: "Sudden Death",
    drill_surv_desc: "15s per question",
    prescribed_ca: "Teacher Assignments",
    knec_paper3_target: "Paper 3 Target",
    mwalimu_diag_title: "Study Tip",
    pedagogical_hint: "Tip",
    prescribed_practical: "Suggested Practical",
    syllabus_focus: "Syllabus Focus",
    launch_prescribed: "Start Session →",
    pathway_heading: "Practical Chemistry Topics",
    pathway_sub: "Choose a topic or follow the guided pathway:",
    btn_learning_pathway: "Pathway View",
    btn_discipline_grid: "Grid View",
    syllabus_mastery: "SYLLABUS MASTERY",
    ref_title: "Revision Reference",
    ref_sub: "Key observational criteria, flame colors, and chemistry formulas.",
    ind_title: "Acid-Base Indicators",
    gas_title: "Gas Confirmatory Tests",
    cation_title: "Cation Tests & Separation",
    flame_title: "Flame Emission Tests",
    anion_title: "Anion Identification",
    org_title: "Organic Chemistry Functional Groups",
    phys_title: "Key Formulas & Volumetric Concordancy",
    achieve_title: "Achievements & History",
    achieve_sub: "Review your earned badges, class leaderboard standing, and practical records.",
    honors_title: "Top Achievement",
    prodigy_title: "Chemistry Mastery",
    prodigy_desc: "Attained for achieving ≥80% practical accuracy across all syllabus disciplines.",
    badges_title: "Practical Competency Badges",
    leaderboard_title: "Class Standings",
    recent_title: "Recent Practical Sessions",
    research_heading: "Assessments & Surveys",
    research_sub: "Standardized diagnostic assessments and feedback surveys.",
    btn_pre_test: "Take CPCAT Pre-Test",
    btn_post_test: "Take CPCAT Post-Test",
    btn_sus: "System Usability Survey (SUS)",
    btn_tam: "Student TAM Survey",
  ...
  sw: {
    ...
    // Student Hub Specific Translations
    candidate_ledger: "Kumbukumbu za Vitendo",
    pre_lab_drill: "Mazoezi ya Awali →",
    tab_benches: "Benchi za Maabara",
    tab_reference: "Marejeleo",
    tab_achievements: "Nishani na Historia",
    tab_research: "Tathmini na Tafiti",
    m_workbenches: "Maabara",
    m_revision: "Marejeleo",
    m_badges: "Nishani",
    m_research: "Utafiti",
    daily_bite_tag: "Changamoto ya Siku",
    daily_bite_bonus: "+100 XP",
    daily_bite_timer: "Inaanza upya usiku wa manane",
    daily_bite_title: "Mtihani wa Haraka wa Siku",
    daily_bite_desc: "Maswali 3 ya haraka kufanya mazoezi ya utambuzi na hesabu.",
    daily_bite_launch: "Anza Mtihani →",
    drills_title: "Mazoezi ya Haraka ya Utambuzi",
    drills_sub: "Chagua mada kwa ajili ya mtihani wa haraka wa kupima umakini wako:",
    drills_badge: "Mazoezi ya Haraka",
    ...
    drill_surv_title: "Mtihani wa Ghafla",
    drill_surv_desc: "Sekunde 15 kwa kila swali",
    prescribed_ca: "Kazi za Mwalimu",
    knec_paper3_target: "Lengo la KNEC Paper 3",
    mwalimu_diag_title: "Ushauri wa Masomo",
    pedagogical_hint: "Kidokezo",
    prescribed_practical: "Jaribio Lililopendekezwa",
    syllabus_focus: "Mkazo wa Silabasi",
    launch_prescribed: "Anza Jaribio →",
    pathway_heading: "Mada za Vitendo vya Kemia",
    pathway_sub: "Fuata njia elekezi ya umahiri au chunguza benchi mahususi za maabara:",
    btn_learning_pathway: "Njia Elekezi",
    btn_discipline_grid: "Jedwali la Mada",
    syllabus_mastery: "UMAHIRI WA SILABASI",
    ref_title: "Marejeleo ya Vitendo",
    ref_sub: "Vigezo vya uchunguzi, rangi za moto, na fomula za kemia.",
    ind_title: "Viashiria vya Asidi na Besi",
    gas_title: "Vipimo vya Gesi",
    cation_title: "Utambuzi wa Cation",
    flame_title: "Vipimo vya Moto",
    anion_title: "Utambuzi wa Anion",
    org_title: "Vikundi vya Kazi vya Kemia Hai",
    phys_title: "Fomula Kuu na Usawa wa Titration",
    achieve_title: "Mafanikio na Historia",
    achieve_sub: "Kagua nishani zako, nafasi yako darasani, na rekodi za majaribio.",
    honors_title: "Mafanikio Makuu",
    prodigy_title: "Umahiri wa Kemia",
    prodigy_desc: "Imetolewa kwa kufikisha usahihi wa ≥80% katika majaribio yote ya silabasi ya KCSE Paper 3.",
    badges_title: "Nishani za Umahiri",
    leaderboard_title: "Nafasi Darasani",
    recent_title: "Majaribio ya Hivi Karibuni",
    research_heading: "Tathmini na Tafiti",
