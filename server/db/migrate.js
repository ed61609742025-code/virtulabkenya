...
const migrations = [
  ...
  `CREATE TABLE IF NOT EXISTS assignment_submissions (
     ...
     qualitative_session_id INTEGER,
     organic_session_id INTEGER,
     composite_session_id INTEGER,
     solubility_session_id INTEGER,
     energy_session_id INTEGER,
     rates_session_id INTEGER,
     gas_session_id INTEGER,
  ...
  `ALTER TABLE practical_sessions
     ...
     ADD COLUMN IF NOT EXISTS true_value DECIMAL(10,4),
     ADD COLUMN IF NOT EXISTS correct BOOLEAN DEFAULT FALSE,
  ...
  // Ensure assignment_submissions has all session link columns and timestamp/feedback fields
